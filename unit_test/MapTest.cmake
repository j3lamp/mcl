...
test(mapTest setOneKeySeveralTimes_getYieldsLastValueSet)
    mcl_map(SET mapTest ${key1} ${val1})
...
test(mapTest setOneKeySeveralTimes_keysYieldsOneKey)
    mcl_map(SET mapTest ${key1} ${val1})
    mcl_map(SET mapTest ${key1} ${val2})
    mcl_map(SET mapTest ${key1} ${val3})
...
test(mapTest setSeveralKeys_containsYieldsCorrectResults)
    mcl_map(SET mapTest ${key1} ${val1})
    mcl_map(SET mapTest ${key2} ${val2})
    mcl_map(SET mapTest ${key3} ${val3})
